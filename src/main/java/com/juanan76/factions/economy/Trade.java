...
public class Trade {
	...
	private static class MenuMain extends Menu {
		...
		public MenuMain(FPlayer viewer, int m1, int m2, String traderName) {
			super(viewer, 54);
		}
		...
		public void initContents() {
			...
			it.setLore(Arrays.asList(new String[] {"",Util.getMoney(this.m1)}));
			...
			it = tm.getItemMeta();
			it.setDisplayName(ChatColor.DARK_GREEN+ChatColor.BOLD.toString()+"Money in trade:");
			it.setLore(Arrays.asList(new String[] {"",Util.getMoney(this.m2)}));
			...
			super.contents.put(48, new ItemSwapMenu(this,new ItemStack(Material.FERN,1),new MenuMainAccepting(viewer,m1,m2,name2)));
		}
	...
	{
		public MenuMainAccepting(FPlayer viewer, int m1, int m2, String traderName) {
			super(viewer, m1, m2, traderName);
		}
